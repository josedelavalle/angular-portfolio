...
export class GridComponent implements OnInit {
  ...
  [
    ...
    { id: 4, type: 'tech', footer: 'Some technologies used', rowspan: 1, colspan: 1, colspanxs: 1, rowspanxs: 1, rowspansm: 1, rowspanmd: 1, rowspanlg: 2},
    ...
    [{ id: 19, type: 'iframe', footer: 'Drill down for county government links and local photos', rowspan: 3, colspan: 7, colspanxl: 7, colspansm: 2, colspanxs: 2, rowspansm: 2, rowspanxs: 3, colspanmd: 3, rowspanmd: 2, colspanlg: 5, rowspanlg: 3 },
    { id: 16, type: 'color', footer: 'Color controls', rowspan: 1, colspan: 1, colspanmd: 1, colspansm: 2, colspanxs: 2 },
    { id: 17, type: 'tech', footer: 'Some technologies used', rowspan: 1, rowspansm: 1, rowspanxs: 1, colspansm: 1, colspanxs: 2, colspan: 1, rowspanlg: 2, rowspanmd: 1},
    { id: 21, type: 'social', footer: 'Places to find me', rowspan: 1, colspan: 1, colspanxl: 1, colspanmd: 1, colspanlg: 2, colspanxs: 2, colspansm: 1 },
    { id: 18, type: 'map', footer: 'How far you are from me', rowspan: 1, colspan: 2, colspanlg: 4, colspanxl: 7, colspansm: 2,  colspanmd: 3, rowspanlg: 1, rowspanmd: 1}],
    
    
    [{ id: 12, type: 'color', footer: 'Color controls', rowspan: 1, colspan: 1, colspanxl: 1, colspanlg: 1, colspanmd: 1, colspansm: 2, colspanxs: 2, hiddenxs: true },
    ...
    { id: 15, type: 'map', footer: 'How far you are from me', colspanxs: 2, colspansm: 2, colspanxl: 9, rowspan: 1, colspan: 8, colspanmd: 2, colspanlg: 5 }],
    ...
    [{ id: 23, type: 'color', footer: 'Color controls', rowspan: 1, colspan: 1, hiddenxs: true },
    { id: 27, type: 'tech', footer: 'Some technologies used', rowspan: 1, colspan: 1 },
    { id: 25, type: 'map', footer: 'How far you are from me', rowspan: 1, colspan: 6, colspanxl: 6, colspanlg: 4, colspanmd: 2, colspansm: 1, colspanxs: 1 },
  ...
  get filteredTiles() : any {
    if (!this.tiles) return "";
    if (this.isMobile) {
      return this.tiles.filter(x => !x.hiddenxs);
    } else {
      return this.tiles;
    }
  }
